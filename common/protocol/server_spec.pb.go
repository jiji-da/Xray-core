...
type ServerEndpoint struct {
	...
	UdpSpeeder uint32          `protobuf:"varint,5,opt,name=udpSpeeder,proto3" json:"udpSpeeder,omitempty"`
}
...
func (x *ServerEndpoint) GetSni() string {
	if x != nil {
		return x.Sni
	}
	return ""
...
func (x *ServerEndpoint) GetUdpSpeeder() uint32 {
	if x != nil {
		return x.UdpSpeeder
	}
	return 0
...
var file_common_protocol_server_spec_proto_rawDesc = []byte{
	...
	0xbd, 0x01, 0x0a, 0x0e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69,
	...
	0x6f, 0x6c, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x10, 0x0a,
	0x03, 0x73, 0x6e, 0x69, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x73, 0x6e, 0x69, 0x12,
	0x1e, 0x0a, 0x0a, 0x75, 0x64, 0x70, 0x53, 0x70, 0x65, 0x65, 0x64, 0x65, 0x72, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x0a, 0x75, 0x64, 0x70, 0x53, 0x70, 0x65, 0x65, 0x64, 0x65, 0x72, 0x42,
